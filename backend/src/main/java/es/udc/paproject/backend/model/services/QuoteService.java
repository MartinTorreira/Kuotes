...
public interface QuoteService {
    ...
    Quote createQuote(Long userId, String title, String description, LocalDateTime date, LocalDateTime endDate, String importance) throws InstanceNotFoundException;
