...
const QuoteInput = ({ label, type, name, value, onChange, placeholder }) => {
    ...
    return(
        <div className="flex flex-row mb-5 justify-start gap-x-10 px-10">
            <div className="flex items-left">
                <label htmlFor="base-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white p-2">{label}</label>
            </div>
            <div>
                <input 
