    ...
    return (
        ...
        <div class="mt-20 w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-[#25252f] dark:border-gray-700">
            ...
            <ul class="my-4 space-y-3">
                <li>
                    <a href="/users/signup" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-100 hover:bg-gray-200 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
